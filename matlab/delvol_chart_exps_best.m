...
title_obj = title(han,'Best Expected vs. Predicted Values of Fracture Densities');
...
title_obj = title(han,'Best Expected vs. Predicted Values of Fracture Densities (Log)');
titlePos = get(title_obj , 'position');
titlePos(1) = 0.4;
titlePos(2) = 1.02;
set(title_obj, 'position' , titlePos);
