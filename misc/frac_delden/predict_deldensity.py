...
for feat_str in featcombins:
    ...
    features = ['glob_den', 'sigd', 'ep', 'del_f', 'del_sig', 'del_ep', 'den_p10', 'den_p20', 'den_p30', 'den_p40', 'den_p50', 'den_mean', 'den_p60', 'den_p70', 'den_p80', 'den_p90', 'den_max', 'den_sum', 'den_std', 'den_numloc', 'den_volloc', 'dist_p10', 'dist_p20', 'dist_p30', 'dist_p40', 'dist_p50', 'dist_mean', 'dist_p60', 'dist_p70', 'dist_p80', 'dist_p90', 'dist_max', 'dist_sum', 'dist_std', 'c_20', 'c_30', 'c_40', 'c_50', 'c_60', 'c_70', 'c_80', 'c_90', 'c_10', 'c_len'];
    featinds = list(range(1, len(features)+1))

    if 'noglobden' in feat_str:
        features = ['sigd', 'ep', 'del_f', 'del_sig', 'del_ep', 'den_p10', 'den_p20', 'den_p30', 'den_p40', 'den_p50', 'den_mean', 'den_p60', 'den_p70', 'den_p80', 'den_p90', 'den_max', 'den_sum', 'den_std', 'den_numloc', 'den_volloc', 'dist_p10', 'dist_p20', 'dist_p30', 'dist_p40', 'dist_p50', 'dist_mean', 'dist_p60', 'dist_p70', 'dist_p80', 'dist_p90', 'dist_max', 'dist_sum', 'dist_std', 'c_20', 'c_30', 'c_40', 'c_50', 'c_60', 'c_70', 'c_80', 'c_90', 'c_10', 'c_len'];
        del featinds[0]
    elif 'micro' in feat_str:
        features = ['den_p10', 'den_p20', 'den_p30', 'den_p40', 'den_p50', 'den_mean', 'den_p60', 'den_p70', 'den_p80', 'den_p90', 'den_max', 'den_sum', 'den_std', 'den_numloc', 'den_volloc', 'dist_p10', 'dist_p20', 'dist_p30', 'dist_p40', 'dist_p50', 'dist_mean', 'dist_p60', 'dist_p70', 'dist_p80', 'dist_p90', 'dist_max', 'dist_sum', 'dist_std', 'c_20', 'c_30', 'c_40', 'c_50', 'c_60', 'c_70', 'c_80', 'c_90', 'c_10', 'c_len'];
        del featinds[0:6]
    elif 'curr' in feat_str:
        features = ['glob_den', 'sigd', 'ep', 'den_p10', 'den_p20', 'den_p30', 'den_p40', 'den_p50', 'den_mean', 'den_p60', 'den_p70', 'den_p80', 'den_p90', 'den_max', 'den_sum', 'den_std', 'den_numloc', 'den_volloc', 'dist_p10', 'dist_p20', 'dist_p30', 'dist_p40', 'dist_p50', 'dist_mean', 'dist_p60', 'dist_p70', 'dist_p80', 'dist_p90', 'dist_max', 'dist_sum', 'dist_std', 'c_10', 'c_20', 'c_30', 'c_40', 'c_50', 'c_60', 'c_70', 'c_80', 'c_90', 'c_len'];
        del featinds[3:6]
    ...
    score_txt = 'txts/pred_delden_allexp_'+feat_str+'_score.txt'
    ...
    while ei<=nume:
        ...
        while it<itmax:
            ...
            train, test = df_all[df_all['is_train']==True], df_all[df_all['is_train']==False]
            ...
            parameters = {'colsample_bytree':[0.8, 0.9], 'alpha':[0, 3],
                          'learning_rate': [0.1, 0.2],
                          'n_estimators': [200, 300], 'max_depth':[4, 5, 6]}
            ...
            curr_str = "%d %d %d %d %.4f %.4f %.4f %.4f \n" % (ei, it, n_train, n_test, rmse_train, r2_train, rmse_test, r2_test)
