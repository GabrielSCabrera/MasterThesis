filenames1 = ["WG02_dmin_min_avg.csv", "MONZ3_dmin_75_avg.csv", "M8_2_dmin_75_avg.csv"];
filenames2 = ["WG02_delvtot.csv", "MONZ3_delvtot.csv", "M8_2_delvtot.csv"];

abbrv = ["\boldmath$d_{min}$ min.", "\boldmath$d_{min}$ 75\%", "\boldmath$d_{min}$ 75\%"];
titles = ["Granite 2", "Monzonite 3", "Marble 2"];
