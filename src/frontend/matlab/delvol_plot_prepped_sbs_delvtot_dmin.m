filenames = ["WG01_dmin_min.csv", "WG01_dmin_50", "WG01_dmin_75.csv"];
abbrv = ["\boldmath$d_{min}$ min.", "\boldmath$d_{min}$ 50\%", "\boldmath$d_{min}$ 75\%"];

filenames2 = ["WG01_delvtot.csv", "WG01_delvtot.csv", "WG01_delvtot.csv"];

titles = ["Granite 1", "Granite 1", "Monzonite 1"];
