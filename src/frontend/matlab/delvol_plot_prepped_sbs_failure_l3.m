filenames1 = ["WG02_l3_25_avg.csv", "WG04_l3_max_avg.csv", "M8_1_l3_25_avg.csv"];
filenames2 = ["WG02_delvtot.csv", "WG04_delvtot.csv", "M8_1_delvtot.csv"];

abbrv = ["\boldmath$L_{max}$ 25 \%", "\boldmath$L_{max}$ max.", "\boldmath$L_{max}$ 25 \%"];
titles = ["Granite 2", "Granite 4", "Marble 1"];
