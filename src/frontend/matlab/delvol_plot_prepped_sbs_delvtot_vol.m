filenames = ["M8_2_vol_50.csv", "WG04_vol_50", "MONZ5_vol_min.csv"];
abbrv = ["\boldmath$v$ 75\%", "\boldmath$v$ 50\%", "\boldmath$v$ 25\%"];

filenames2 = ["M8_2_delvtot.csv", "WG04_delvtot.csv", "MONZ5_delvtot.csv"];

titles = ["Marble 2", "Granite 4", "Monzonite 5"];
