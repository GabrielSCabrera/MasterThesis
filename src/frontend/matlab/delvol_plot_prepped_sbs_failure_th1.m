filenames1 = ["WG01_th1_25_avg.csv", "M8_1_th1_min_avg.csv", "MONZ3_th1_75_avg.csv"];
filenames2 = ["WG01_delvtot.csv", "M8_1_delvtot.csv", "MONZ3_delvtot.csv"];

abbrv = ["\boldmath$\theta_1$ 25 \%", "\boldmath$\theta_1$ min.", "\boldmath$\theta_1$ 75\%"];
titles = ["Granite 1", "Marble 1", "Monzonite 3"];
